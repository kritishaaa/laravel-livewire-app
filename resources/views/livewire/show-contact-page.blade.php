							...
							<div class="contact-form">
								<form wire:submit="submit">
									<div class="form-group mb-4 pb-2">
										...
										<input wire:model="name" name="name" type="text" class="form-control shadow-none" id="name">
									</div>
									<div class="form-group mb-4 pb-2">
										<label for="email" class="form-label">Email address</label>
										<input wire:model="email" name="email" type="email" class="form-control shadow-none" id="email">
                                    </div>
									<div class="form-group mb-4 pb-2">
										<label for="message" class="form-label">Write Message</label>
										<textarea  wire:model="message" name="message" class="form-control shadow-none" id="message" rows="3"></textarea>
                                    </div>
