...
<header class="navigation bg-tertiary">
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a link:navigate class="navbar-brand" href="{{route('home')}}">
		...
		<div class="row justify-content-between">
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						...
						<li class="mb-2"><a wire:navigate href="{{route('showService', $service->id)}}">{{$service->title}}</a>
						</li>
						@endforeach
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a wire:navigate class="text-black" href="{{route('page', 3)}}">Privacy Policy</a>
                        </li>
						<li class="list-inline-item me-4"><a wire:navigate class="text-black" href="{{route('page', 2)}}">Terms &amp; Conditions</a>
                        </li>
					</ul>
				</div>
			</div>			
